...
Every post is a `.md` (Markdown) file inside `content/posts/`. When you commit a new or edited file to GitHub, the site rebuilds and goes live aut omatically in a bout 60 seconds. That's it — no dashboard, no CMS, no build limits.
